#pragma checksum "C:\Users\Dell\Desktop\bca4thsem_dotnetcore_mvc_web_app\Views\_ViewImports.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "611b239ef6ae9b32b4cba408aa5ed3a1ffee7262"
// <auto-generated/>
...
<div>
    <div class=""accordion"" id=""accordionExample"">
                ...
                <h2 class=""mb-0"">
                    <button class=""btn btn-link"" type=""button"" data-toggle=""collapse"" data-target=""#collapseOne"" aria-expanded=""true"" aria-controls=""collapseOne"">
                        <svg xmlns=""http://www.w3.org/2000/svg"" width=""16"" height=""16"" fill=""currentColor"" class=""bi bi-newspaper"" viewBox=""0 0 16 16"">
                            ...
                            <path d=""M2 3h10v2H2V3zm0 3h4v3H2V6zm0 4h4v1H2v-1zm0 2h4v1H2v-1zm5-6h2v1H7V6zm3 0h2v1h-2V6zM7 8h2v1H7V8zm3 0h2v1h-2V8zm-3 2h2v1H7v-1zm3 0h2v1h-2v-1zm-3 2h");
            WriteLiteral(@"2v1H7v-1zm3 0h2v1h-2v-1z"" />
                        </svg> Manage Post
                    </button>
                </h2>
            </div>
        ...
        <div class=""card"">
            <div class=""card-header"" id=""headi");
            WriteLiteral(@"ngTwo"">
                <h2 class=""mb-0"">
            ...
            WriteLiteral(@"tic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                </div>
            </div>
        </div>
        <div class=""card"">
            ...
            <div id=""collapseThree"" class=""collapse"" aria-labelledby=""headingThree"" data-parent=""#accordionExample"">
                <div class=""card-body"">
                    Anim pa");
            WriteLiteral(@"riatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                </div>
            </div>
        </div>
    </div>
